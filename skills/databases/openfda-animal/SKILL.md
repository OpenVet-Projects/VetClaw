...
- User presents a case or question involving openfda animal in a veterinary context
- User asks about species-specific approaches to openfda animal
- Keywords: openFDA, FDA, CVM, adverse event, API, animal drug, veterinary device, NADA
