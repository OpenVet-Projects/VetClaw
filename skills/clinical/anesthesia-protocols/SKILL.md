...
description: Species-specific anesthesia protocols including premedication, induction, maintenance, and monitoring. Accounts for brachycephalic risk, sighthound sensitivity, and ASA classification.
---
...
Species-specific anesthesia protocols including premedication, induction, maintenance, and monitoring. Accounts for brachycephalic risk, sighthound sensitivity, and ASA classification.

## When to Use

- User presents a case or question involving anesthesia protocols in a veterinary context
- User asks about species-specific approaches to anesthesia protocols
- Keywords: anesthesia, sedation, premedication, induction, intubation, isoflurane, sevoflurane, propofol, ASA, monitoring
