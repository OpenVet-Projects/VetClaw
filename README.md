...
[![Skills](https://img.shields.io/badge/skills-45-blue?style=flat-square)](/skills)
[![Clinical](https://img.shields.io/badge/%F0%9F%A9%BA_clinical-16-brightgreen?style=flat-square)](/skills/clinical)
[![Pharma](https://img.shields.io/badge/%F0%9F%92%8A_pharma-6-blueviolet?style=flat-square)](/skills/pharma)
[![Species](https://img.shields.io/badge/%F0%9F%90%BE_species-8-orange?style=flat-square)](/skills/species)
[![Literature](https://img.shields.io/badge/%F0%9F%93%9A_literature-6-purple?style=flat-square)](/skills/literature)
...
| [Pharma](/skills/pharma) | **6** | Drug lookup, FDA Green Book, drug interactions, adverse event reporting, withdrawal times, compounding |
...
| [Literature](/skills/literature) | **6** | Veterinary PubMed search, evidence grading, textbook hierarchy, comparative medicine, OMIA, VBO |
...
```
git clone https://github.com/OpenVetAI/VetClaw.git
...
└── skills/
    ...
    ├── pharma/         # 6 skills: drug lookup, FDA Green Book, interactions, adverse events, withdrawal, compounding
    ├── species/        # 8 skills: breed predisposition, species reasoning, canine, feline, equine, ruminant, avian, exotic
    ├── literature/     # 6 skills: PubMed search, evidence grading, textbook hierarchy, comparative medicine, OMIA, VBO
